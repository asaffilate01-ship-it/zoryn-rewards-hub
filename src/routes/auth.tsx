...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Melde dich bei Zoryn an oder erstelle deine Wallet in 30 Sekunden.",
      },
    ],
  }),
  component: AuthPage,
...
function GoogleIcon() {
  return (
    <svg viewBox="0 0 24 24" className="mr-2 size-4">
      <path
        fill="#EA4335"
        d="M12 10.2v3.9h5.4c-.24 1.3-1.7 3.8-5.4 3.8-3.24 0-5.9-2.7-5.9-6s2.66-6 5.9-6c1.85 0 3.08.79 3.79 1.47l2.58-2.5C16.9 3.4 14.72 2.4 12 2.4 6.9 2.4 2.8 6.5 2.8 11.6s4.1 9.2 9.2 9.2c5.32 0 8.83-3.74 8.83-9 0-.6-.07-1.06-.15-1.6H12z"
      />
    </svg>
  );
}
