  ...
  component: () => (
    <FeaturePage
      ...
      features={[
        {
          icon: ScanLine,
          title: "Nummer oder QR",
          body: "Mitglied per 8-stelligem Code oder QR erkennen.",
        },
        { icon: Clock, title: "Unter 10 Sekunden", body: "Vergabe/Einlösung in einem Screen." },
        {
          icon: BadgeCheck,
          title: "Code-Verifikation",
          body: "Rewards nur mit gültigem Einlöse-Code entwerten.",
        },
        {
          icon: Handshake,
          title: "Kein App-Zwang",
          body: "Kundschaft muss die App nicht offen haben.",
        },
        {
          icon: ShieldCheck,
          title: "Rollenbasiert",
          body: "Owner-Freischaltung erforderlich, saubere Audit-Spur.",
        },
