    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 pt-20 pb-32 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg text-muted-foreground">
              Zoryn ist die eine Wallet für Punkte, Cashback, Affiliate-Shopping,
              lokale Angebote und Händlerbelohnungen. Ein Konto — jedes Angebot,
              online und im Kiez.
            </p>

            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Button asChild size="lg" className="gradient-brand text-primary-foreground border-0 glow-brand">
                <Link to="/auth">
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-muted-foreground">
            Sammle Punkte beim Bäcker um die Ecke, beim Online-Shop und über
            LoungeTech-Apps — und löse sie überall im Zoryn-Netzwerk ein.
          </p>
        </div>
      ...
      <section id="merchants" className="relative border-t border-border">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Zoryn gibt dir händlerspezifische Punkte, universelle Netzwerkpunkte,
              Kampagnen, Abrechnung und Betrugsschutz in einem Portal. Starte in
              Minuten, wachse mit dem Netzwerk.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="gradient-brand text-primary-foreground border-0">
      ...
      <section className="border-t border-border">
        <div className="mx-auto max-w-5xl px-6 py-24 text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Erstelle in 30 Sekunden dein Zoryn-Konto und starte mit einem
            Willkommensbonus.
          </p>
          <div className="mt-8">
            <Button asChild size="lg" className="gradient-brand text-primary-foreground border-0 glow-brand">
              <Link to="/auth">Kostenlos starten <ArrowRight className="ml-2 size-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
