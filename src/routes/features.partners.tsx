...
export const Route = createFileRoute("/features/partners")({
  ...
  component: () => (
    <FeaturePage
      ...
      features={[
        { icon: Handshake, title: "Affiliate-Deals", body: "Cashback-Kampagnen im Namen des Netzwerks." },
        { icon: Percent, title: "Revenue-Share", body: "Faire Beteiligung an Aktivierungen." },
        { icon: Megaphone, title: "Co-Marketing", body: "Feature-Placement in App, Blog und Social." },
        ...
        { icon: Globe2, title: "LoungeTech-Netzwerk", body: "Kiezio, Rettio, Haccora, TrainDirekt teilen die Wallet." },
      ]}
