...
export const Route = createFileRoute("/legal/aml")({
  head: () => ({
    meta: [
      { title: "AML / KYC — Zoryn" },
      { name: "description", content: "Kurzhinweise zu Geldwäscheprävention und Identitätsprüfung." },
  ...
  component: () => (
    <PublicShell>
      <PageHeader eyebrow="Rechtliches" title="AML & KYC" description="Kurzüberblick zur Geldwäscheprävention." />
      <section className="mx-auto max-w-3xl space-y-6 px-4 py-14 sm:px-6">
        ...
        <div className="prose prose-invert max-w-none text-foreground [&_p]:text-muted-foreground [&_li]:text-muted-foreground [&_ul]:list-disc [&_ul]:pl-5">
          <p>
            Zoryn-Punkte sind eine limitierte Loyalitätswährung ohne Bargeld-Rückerstattung und stellen
            kein E-Geld dar. Wir setzen dennoch angemessene Kontrollen zur Missbrauchs- und
