  ...
  component: () => (
    <PublicShell>
      <PageHeader
        ...
        description="Transparenz über alle Cookie-Kategorien in Zoryn."
      />
      <section className="mx-auto max-w-3xl space-y-6 px-4 py-14 sm:px-6">
        ...
        <div className="prose prose-invert max-w-none text-foreground [&_h2]:mt-10 [&_h2]:font-display [&_h2]:text-2xl [&_h2]:font-semibold [&_p]:text-muted-foreground [&_li]:text-muted-foreground [&_ul]:list-disc [&_ul]:pl-5">
          <h2>Notwendig</h2>
          <p>
            Diese Cookies sind für Anmeldung, Sicherheit und das Speichern deiner Cookie-Präferenz
            erforderlich. Sie lassen sich nicht deaktivieren.
          </p>
          <h2>Analyse</h2>
          <p>
            Optional. Wir messen anonymisiert, welche Bereiche der App genutzt werden, um Zoryn zu
            verbessern.
          </p>
          <h2>Marketing</h2>
