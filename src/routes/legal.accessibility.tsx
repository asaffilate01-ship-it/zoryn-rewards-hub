...
export const Route = createFileRoute("/legal/accessibility")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "So arbeiten wir an einer barrierefreien Zoryn-Erfahrung." },
  ...
  component: () => (
    <PublicShell>
      <PageHeader eyebrow="Rechtliches" title="Erklärung zur Barrierefreiheit" description="Unser laufendes Bekenntnis zu WCAG 2.2 AA." />
      <section className="mx-auto max-w-3xl space-y-6 px-4 py-14 sm:px-6">
        ...
        <p className="text-muted-foreground">
          ...
          <a href="mailto:a11y@zoryn.app" className="text-brand underline underline-offset-2">a11y@zoryn.app</a>.
        </p>
      </section>
    </PublicShell>
  ),
