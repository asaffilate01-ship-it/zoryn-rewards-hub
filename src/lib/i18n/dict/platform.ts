export const platform: Record<string, string> = {
  ...
  "ja": "yes",
  "nein": "no",
  "Noch kein Abonnement aktiv – wähle unten einen Tarif.": "No subscription yet — pick a plan below.",
  "aktiv": "active",
  "Monat": "month",
  "Jährlich": "Annual",
  ...
  "Tarife, Limits und Abonnementstatus für Starter, Growth und Pro – inklusive Laufzeit und Kündigungsstatus.": "Plans, limits and subscription status for Starter, Growth and Pro \u2014 including term and cancellation status.",
  ...
  "Gestartet": "Started",
  "Tägliche Abstimmung von Haftung, Händlerdeckung, Settlement und Affiliate mit Soll-Ist-Differenzen.": "Daily reconciliation of liability, merchant funding, settlement and affiliate with expected-vs-actual differences.",
};
